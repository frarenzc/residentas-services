...
async function recordStatusChange(reference: string, from: string, to: BookingStatus, actor: string) {
...
export async function PATCH(request: NextRequest) {
  ...
  await recordStatusChange(reference, previousStatus, status, auditActor(body));
